                        ...
                        <div className="w-full max-w-md py-8">
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-amber-700 mt-1">
                                            Register using your ONGC corporate credentials.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="text-center mb-8">
                                ...
                                <p className="text-gray-600 mt-2">
                                    Register to access the Request Management System
                                </p>
                            </div>
                                ...
                                {({ processing, errors }) => (
                                    <>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <Button
                                                type="submit"
                                                className="w-full py-6 mt-4 bg-gradient-to-r from-blue-600 to-emerald-600 hover:from-blue-700 hover:to-emerald-700 text-white font-semibold shadow-lg hover:shadow-xl transition-all duration-300"
                                                tabIndex={6}
                                                disabled={processing}
