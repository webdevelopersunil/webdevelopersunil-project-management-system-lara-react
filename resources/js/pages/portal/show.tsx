            ...
            {activeTab === 'collaborations' && (
              <div className="rounded-xl border border-sidebar-border/70 bg-card dark:border-sidebar-border">
                ...
                <div className="border-t border-sidebar-border/70 p-6 dark:border-sidebar-border">
                  <button onClick={ () => { alert('hellow') } } className="inline-flex w-full items-center justify-center gap-2 rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm font-medium hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
