...
interface Portal {
    ...
    is_public: boolean;
    machine_type: 'Windows' | 'RHEL' | 'Ubuntu' | 'CentOS' | 'Other' | 'Not-Defined';
}
...
export default function PortalEdit({ portal }: EditProps) {
    const { data, setData, put, processing, errors } = useForm({
        name: portal.name || '',
        url: portal.url || '',
        active: portal.active ?? true,
        ip_address: portal.ip_address || '',
        status: portal.status || 'pending',
        server_backup: portal.server_backup ?? false,
        db_backup: portal.db_backup ?? false,
        migrate_to_new_server: portal.migrate_to_new_server ?? false,
        domain: portal.domain || '',
        vm_name: portal.vm_name || '',
        framework: portal.framework || '',
        framework_version: portal.framework_version?.toString() || '',
        database: portal.database || '',
        database_version: portal.database_version?.toString() || '',
        machine_type: portal.machine_type || 'Windows',
        description: portal.description || '',
        is_public: portal.is_public ?? false,
    });
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="container mx-auto py-6 max-w-4xl">
                ...
                <Card>
                    <CardHeader>
                        <CardTitle className="text-2xl">Edit Portal: {portal.name}</CardTitle>
                        <CardDescription>
                            Update the details for this portal
                        </CardDescription>
                    </CardHeader>
                    ...
                    <form onSubmit={handleSubmit}>
                        <CardContent className="space-y-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div className="space-y-0.5">
                                            <Label htmlFor="is_public">Exposed To Internet</Label>
                                            <p className="text-sm text-gray-500">
                        ...
                        <CardFooter className="flex justify-between border-t px-6 py-4">
                            ...
                            <Button type="submit" disabled={processing} className="gap-2">
                                ...
                                {processing ? 'Updating...' : 'Update Portal'}
                            </Button>
                        </CardFooter>
                    </form>
                </Card>
